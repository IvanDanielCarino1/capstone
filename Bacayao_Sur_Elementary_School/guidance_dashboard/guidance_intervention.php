    ...
    <h1 style="color: white;">Intervention in Behavioral</h1>
            ...
            <div class="rows">
                ...
                <div class="containers" style="background-color: #190572;">
                    <h3 style="margin-left: 7px">S.Y: </h3>
                </div>
            </div>
            <div class="column column-right">
            <div class="containerss " style="background-color: #F3F3F3; width:560px">
                        <input type="text" name="quarter" id="quarter" value="<?php echo isset($_GET['school_year']) ? htmlspecialchars($_GET['school_year']) : ''; ?>" readonly>
                    </div>
            </div>
